...
return [
    ...
    */
    ...
    'sets' => [
        ...
        /*
        | Heroicons via blade-ui-kit/blade-heroicons. The package registers its
        | own set (components like <x-heroicon-o-envelope /> for outline,
        | <x-heroicon-s-envelope /> for solid, <x-heroicon-m-... /> for mini),
        | so it is intentionally NOT re-declared here.
        */
